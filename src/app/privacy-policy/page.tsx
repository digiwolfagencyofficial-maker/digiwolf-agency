...
• Contractual necessity: when processing is required to fulfil a contract or take steps prior to entering a contract
• Legitimate interests: when we have a legitimate business interest that is not overridden by your rights
• Legal obligation: when processing is necessary to comply with Czech or EU law
...
You can manage cookie preferences through your browser settings. Refusing analytics cookies does not affect your ability to use the site.`,
  },
  {
...
No method of transmission over the internet is 100% secure. We cannot guarantee absolute security but take all reasonable precautions.`,
  },
  {
    ...
    content: `We may update this Privacy Policy from time to time. We will notify you of material changes by email or by posting a notice on our website. The date of the last revision is shown below. Continued use of our services after changes constitutes acceptance.`,
  },
]
      ...
      <main style={{ maxWidth: 800, margin: '0 auto', padding: '120px 24px 80px' }}>
        ...
        <div style={{ marginBottom: 48 }}>
          ...
          <p style={{ color: '#8892b0', fontSize: 16, lineHeight: 1.7, marginBottom: 20 }}>
            This Privacy Policy explains how Digi Wolf Agency s.r.o. collects, uses, and protects your personal data in compliance with the General Data Protection Regulation (GDPR) and applicable Czech law.
          </p>
