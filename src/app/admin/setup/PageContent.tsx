      ...
      <div style={{ maxWidth: 860, margin: '0 auto' }}>
        ...
        <div style={sectionStyle}>
          ...
          <ol style={{ color: '#c8d3f0', fontSize: 14, lineHeight: 2, paddingLeft: 20, margin: '0 0 24px' }}>
            ...
            <li>Add Authorized redirect URI: <code style={{ background: 'rgba(0,71,255,0.1)', padding: '2px 8px', borderRadius: 6, color: '#93c5fd', fontSize: 12 }}>https://digiwolf.agency/api/auth/google/callback</code></li>
